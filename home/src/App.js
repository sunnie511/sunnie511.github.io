...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      loading: false,
      // viewUrl: "https://sunnie511.github.io/弹性盒模型/align-self.html",
      iframeH: "95vh",
      viewUrl: "",
      lock: false
    };
  ...
  __linkChange = link => {
    this.setState({
      loading: true,
      viewUrl: `https://sunnie511.github.io/${link}`
    });
  };
                ...
                {this.state.viewUrl ? (
                  ...
                  <div style={{marginTop: '20px'}}>
                    ...
                    <Row style={{padding: '10px 0 10px'}}>
                      <Col span={3}><a href="https://github.com/sunnie511/sunnie511.github.io" target="_blank" rel="noopener noreferrer">github仓库</a></Col>
                    </Row>
                    <Alert
